...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('start_date', sa.DateTime(), nullable=False, default=datetime.datetime.now),
    ...
    op.add_column('ab_user', sa.Column('is_paid_user', sa.Boolean(), server_default='0'))
    op.add_column('ab_user', sa.Column('trial_used', sa.Boolean(), server_default='0'))
    op.add_column('ab_user', sa.Column('stripe_customer_id', sa.String(255), nullable=True))
